...
def parse_args():
    ...
    parser.add_argument('--is5zhe', type=int, default=1, help='is5zhe')
    parser.add_argument('--distill', type=int, default=1, help='distill')
    # ========================= Data Configs ==========================
    ...
    parser.add_argument('--test_output_csv', type=str, default='../data/mac_B.csv')
    ...
    parser.add_argument('--ckpt_file', type=str, default='save/v1/model_zhe_epoch_3_mean_f1_0.6.bin')
