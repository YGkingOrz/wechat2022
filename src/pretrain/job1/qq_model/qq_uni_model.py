...
class QQUniModel(nn.Module):
    ...
    def forward(self, video_feature, video_mask, text_input_ids, text_mask, target=None, task=None):
        ...
        return (pred, normed_embedding,loss,masked_lm_loss,masked_vm_loss,itm_loss)
...
class UniBert(BertPreTrainedModel):
    ...
    def forward(self, video_feature, video_mask, text_input_ids, text_mask, gather_index=None):        
        ...
        video_feature = self.sig(self.video_fc(video_feature))
...
#         encoder_outputs1=encoder_outputs['hidden_states'][-1]
#         encoder_outputs2=encoder_outputs['hidden_states'][-2]
#         encoder_outputs3=encoder_outputs['hidden_states'][-3]
#         encoder_outputs4=encoder_outputs['hidden_states'][-4]
