...
def parse_args():
    ...
    parser.add_argument("--fold", type=int, default=1, help="fold___")
    parser.add_argument("--is5zhe", type=int, default=0, help="fold___")
    ...
    parser.add_argument('--ckpt_file', type=str, default='save/v1/model_epoch_1_mean_f1_0.5516.bin')
    ...
    # ========================== Title BERT =============================
    parser.add_argument('--bert_dir', type=str, default='model/chinese-roberta-wwm-ext')
