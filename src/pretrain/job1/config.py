...
def parse_args():
    ...
    parser.add_argument('--is5zhe', type=int, default=0, help='is5zhe')
    # ========================= Data Configs ==========================
    ...
    parser.add_argument('--ckpt_file', type=str, default='save/v1/model_epoch_2_mean_f1_0.6707.bin')
    ...
    parser.add_argument('--warmup_steps', default=1300, type=int, help="warm ups for parameters not in bert or vit")
    ...
    # ========================== Title BERT =============================
    parser.add_argument('--bert_dir', type=str, default='../input/pretrain-model/Bert/')
